...
public class EmailService implements IEmailService {
	...
	public void sendRegistrationUserConfirm(String email) {
		...
		String confirmationUrl = "http://13.212.255.1:8080/api/v1/users/activeUser?token=" + token;
	...
	public void sendResetPassword(String email) {
		...
		String confirmationUrl = "http://13.212.255.1.112:3000/auth/new-password/" + token;
